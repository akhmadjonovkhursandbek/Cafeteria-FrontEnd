      ...
      <Container>
        <Stack flexDirection={"row"} sx={{ mt: "94px" }}>
          <Stack flexDirection={"column"} style={{ width: "340px" }}>
            <Box className={"foot-category-title"}>Cafeteria Contacts</Box>
          ...
          <Stack sx={{ ml: "288px" }} flexDirection={"row"}>
            <Stack>
              <Box>
                ...
                <Box className={"foot-desc-txt"} marginLeft={"0px"}>
        ...
        <Stack className={"copyright-txt"}>
          © Copyright The Cafeteria Restaurant Inc, All rights reserved.
        </Stack>
      </Container>
    </Footers>
  );
